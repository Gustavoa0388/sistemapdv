...
namespace SistemaHotel.Relatorios
{
    partial class FrmRecibo
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.vendasDataSet = new SistemaHotel.vendasDataSet();
            this.detalheslancarvendasPorIdBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.detalhes_lancarvendasPorIdTableAdapter = new SistemaHotel.vendasDataSetTableAdapters.detalhes_lancarvendasPorIdTableAdapter();
            this.lancarvendasPorIdVendasBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.lancar_vendasPorId_VendasTableAdapter = new SistemaHotel.vendasDataSetTableAdapters.lancar_vendasPorId_VendasTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "SistemaHotel.Relatorios.RelRecibo.rdlc";
