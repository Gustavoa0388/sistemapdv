...
{
    public partial class FrmLimparDadosGastos : Form
    {
        ...
        private void FrmLimparDadosGastos_Load(object sender, EventArgs e)
        {
            LoadTheme();
        }
        //metodo BackUp
        ...
        private void LimparDados()
        {
            ...
            if (bkpFeito == "Sim")
            {
                var res = MessageBox.Show("Deseja realmente LIMPAR todos os dados Gastos, desde de " + dtInicial.Text + " até " + dtFinal.Text + " ?", " Sistema Hotel ", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (res == DialogResult.Yes)
                {
                //botao excluir
                con.AbrirConexao();
                sql = "DELETE FROM gastos WHERE data >= @dataInicial AND data <= @dataFinal";
                ...
                cmd.ExecuteNonQuery();
                con.FecharConexao();
                MessageBox.Show("Os dados de gastos foram limpos com sucesso!", "Sistema Hotel", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
