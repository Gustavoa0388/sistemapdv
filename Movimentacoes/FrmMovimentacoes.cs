...
namespace SistemaHotel.Movimentacoes
{
    public partial class FrmMovimentacoes : Form
    {
        ...
        //double totalValorCancelado, totalDinheiro, totalCartao, totalDesconto, totalValorExcluido; // nao usado
        ...
        private void FormatarGD()
        {
            ...
            grid.Columns[5].HeaderText = "Valor";//implementado para descriminar detalhes
        ...
        {
            //Buscartipo();
            BuscarData(); // foi implementado um paramento de busca por tipo em BuscarData(); assim ficou mais completo.
        }
        ...
        private void TotalizandoEntradas()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                if (row.Cells["tipo"].Value.ToString() == "Entrada")
                {
                    ...
                    total += Convert.ToDouble(row.Cells["valor_pago"].Value); //pode ser pelo indece tb
                }
        ...
        private void TotalizandoDinheiro()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                ...
                {
                    //pegando a celular e somando
                    total += Convert.ToDouble(row.Cells["dinheiro"].Value); //pode ser pelo indece tb
                }
        ...
        private void TotalizandoCartao()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                ...
                {
                    //pegando a celular e somando
                    total += Convert.ToDouble(row.Cells["cartao"].Value); //pode ser pelo indece tb
                }
        ...
        private void TotalizandoPix()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                ...
                {
                    //pegando a celular e somando
                    total += Convert.ToDouble(row.Cells["pix"].Value); //pode ser pelo indece tb
                }
        ...
        private void TotalizandoDescontos()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                if (row.Cells["tipo"].Value.ToString() == "Entrada")
                {
                    //pegando a celula e somando
                    total += Convert.ToDouble(row.Cells["desconto"].Value); //pode ser pelo indece tb
                }
            }
            //totalDesconto = total;
        ...
        private void TotalizandoValorExcluido()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                ...
                {
                    //pegando a celular e somando
                    total += Convert.ToDouble(row.Cells["exclusao"].Value); //pode ser pelo indece tb
                }

            }
            //totalValorExcluido = total;
        ...
        private void Totalizando()
        {
            ...
            foreach (DataGridViewRow row in grid.Rows)
            {
                total = totalEntradas + totalSaidas; // é total = totalEntradas - totalSaidas; 19 = 34 - 15; AGORA é total = totalEntradas + totalSaidas; 19 = 34+(-15);
            }
            if (total > 0 )
            {
